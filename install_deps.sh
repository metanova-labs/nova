...
wget -q https://huggingface.co/datasets/Metanova/Mol-Rxn-DB/resolve/main/molecules.sqlite?download=true -O combinatorial_db/molecules.sqlite
...
uv venv --python "$PYTHON_BIN" && source .venv/bin/activate \
        ...
        && uv pip install torch==2.7.1 torchvision==0.22.1 torchaudio==2.7.1 --index-url https://download.pytorch.org/whl/"$CUDA_VERSION" \
